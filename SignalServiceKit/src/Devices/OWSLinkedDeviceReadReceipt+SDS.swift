...
public extension LinkedDeviceReadReceiptRecord {
    ...
    init(row: Row) {
        ...
        recordType = row[1]
        uniqueId = row[2]
        messageIdTimestamp = row[3]
        readTimestamp = row[4]
        senderPhoneNumber = row[5]
        senderUUID = row[6]
    }
}
...
public extension OWSLinkedDeviceReadReceipt {
    ...
    class func anyEnumerate(transaction: SDSAnyReadTransaction,
                            block: @escaping (OWSLinkedDeviceReadReceipt, UnsafeMutablePointer<ObjCBool>) -> Void) {
...
class OWSLinkedDeviceReadReceiptSerializer: SDSSerializer {
    ...
    func asRecord() throws -> SDSRecord {
        ...
        return LinkedDeviceReadReceiptRecord(delegate: model, id: id, recordType: recordType, uniqueId: uniqueId, messageIdTimestamp: messageIdTimestamp, readTimestamp: readTimestamp, senderPhoneNumber: senderPhoneNumber, senderUUID: senderUUID)
    }
}
