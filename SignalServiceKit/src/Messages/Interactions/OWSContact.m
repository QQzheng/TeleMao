    ...
    switch (self.phoneType) {
        ...
        default:
            if (self.label.ows_stripped.length < 1) {
                return NSLocalizedString(@"XXGJUSTHHANQC73", @"Label for a contact's phone number.");
            }
...
- (NSString *)localizedLabel
{
    switch (self.emailType) {
        ...
        default:
            if (self.label.ows_stripped.length < 1) {
                return NSLocalizedString(@"XXGJUSTHHANQC59", @"Label for a contact's email address.");
            }
            return self.label.ows_stripped;
    }
}
...
- (NSString *)localizedLabel
{
    switch (self.addressType) {
        ...
        default:
            if (self.label.ows_stripped.length < 1) {
                return NSLocalizedString(@"XXGJUSTHHANQC54", @"Label for a contact's postal address.");
            }
            return self.label.ows_stripped;
    }
}
...
- (NSString *)displayName
{
    ...
    if (_displayName.length < 1) {
        ...
        return NSLocalizedString(@"XXGJUSTHHANQC83", @"Indicates that a contact has no name.");
    }
    return _displayName;
}
