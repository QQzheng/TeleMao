...
- (NSString *)previewTextWithTransaction:(SDSAnyReadTransaction *)transaction
{
    ...
    if (self.isViewOnceMessage) {
        if ([self isKindOfClass:TSOutgoingMessage.class]) {
            return NSLocalizedString(@"XXGJUSTHHANQP4",
    ...
    if (attachmentDescription.length > 0 && bodyDescription.length > 0) {
        ...
        return NSLocalizedString(@"XXGJUSTHHANQS159",
