...
- (NSString *)previewTextWithTransaction:(SDSAnyReadTransaction *)transaction
{
    switch (_errorType) {
        case TSErrorMessageInvalidMessage:
            return NSLocalizedString(@"XXGJUSTHHANQE47", @"");
        default:
            OWSFailDebug(@"Unknown error type.");
            return NSLocalizedString(@"XXGJUSTHHANQE52", @"");
    }
}
...
- (NSString *)previewTextWithTransaction:(SDSAnyReadTransaction *)transaction
{
    switch (_errorType) {
        case TSErrorMessageNoSession:
            return NSLocalizedString(@"XXGJUSTHHANQE49", @"");
        case TSErrorMessageInvalidMessage:
            return NSLocalizedString(@"XXGJUSTHHANQE47", @"");
        case TSErrorMessageInvalidVersion:
            return NSLocalizedString(@"XXGJUSTHHANQE48", @"");
        case TSErrorMessageDuplicateMessage:
            return NSLocalizedString(@"XXGJUSTHHANQE45", @"");
        case TSErrorMessageInvalidKeyException:
            return NSLocalizedString(@"XXGJUSTHHANQE46", @"");
        case TSErrorMessageWrongTrustedIdentityKey:
            return NSLocalizedString(@"XXGJUSTHHANQE53", @"");
        case TSErrorMessageNonBlockingIdentityChange: {
            if (self.recipientAddress) {
                NSString *messageFormat = NSLocalizedString(@"XXGJUSTHHANQE51",
                ...
                return NSLocalizedString(
                    @"XXGJUSTHHANQE50", @"Shown when signal users safety numbers changed");
            }
        }
        case TSErrorMessageUnknownContactBlockOffer:
            return NSLocalizedString(@"XXGJUSTHHANQU2",
                @"Message shown in conversation view that offers to block an unknown user.");
        case TSErrorMessageGroupCreationFailed:
            return NSLocalizedString(@"XXGJUSTHHANQG17",
