...
- (NSString *)previewTextWithTransaction:(SDSAnyReadTransaction *)transaction
{
    if (self.createdInExistingGroup) {
        ...
        NSString *infoFormat = NSLocalizedString(@"XXGJUSTHHANQD28",
        ...
        if (self.configurationIsEnabled && self.configurationDurationSeconds > 0) {
            NSString *infoFormat = NSLocalizedString(@"XXGJUSTHHANQO45",
            ...
            NSString *infoFormat = NSLocalizedString(@"XXGJUSTHHANQO44",
        ...
        if (self.configurationIsEnabled && self.configurationDurationSeconds > 0) {
            NSString *infoFormat = NSLocalizedString(@"XXGJUSTHHANQY2",
            ...
            return NSLocalizedString(@"XXGJUSTHHANQY1",
