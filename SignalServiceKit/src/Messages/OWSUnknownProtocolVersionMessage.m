...
- (NSString *)messageTextWithTransaction:(SDSAnyReadTransaction *)transaction
{
    if (!self.sender.isValid) {
        ...
        if (self.isProtocolVersionUnknown) {
            return NSLocalizedString(@"XXGJUSTHHANQU5",
            ...
            return NSLocalizedString(@"XXGJUSTHHANQU9",
    ...
    if (self.isProtocolVersionUnknown) {
        if (senderName.length > 0) {
            return [NSString
                stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQU6",
                                     @"Info message recorded in conversation history when local user receives an "
            ...
            return NSLocalizedString(@"XXGJUSTHHANQU7",
        ...
        if (senderName.length > 0) {
            return [NSString
                stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQU10",
            ...
            return NSLocalizedString(@"XXGJUSTHHANQU11",
