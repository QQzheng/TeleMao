...
private class TSConstantsProduction: TSConstantsProtocol {
    ...
    public let textSecureWebSocketAPI = "wss://www.tmao.pro/v1/websocket/" //websocket
    public let textSecureServerURL = "https://www.tmao.pro/" //主服务器
    public let textSecureCDNServerURL = "https://im-telefox.oss-ap-southeast-1.aliyuncs.com" //上传接口
    ...
    public let serviceCensorshipPrefix = "www.tmao.pro"//service
    public let cdnCensorshipPrefix = "im-telefox"//cdn
    ...
    public let applicationGroup = "group.longteng.tele"
