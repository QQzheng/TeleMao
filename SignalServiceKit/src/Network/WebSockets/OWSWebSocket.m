...
- (void)timeoutIfNecessary
{
    NSError *error = OWSErrorWithCodeDescription(OWSErrorCodeMessageRequestFailed,
        NSLocalizedString(
            @"XXGJUSTHHANQE37", @"Error indicating that a socket request timed out."));
...
{
    NSError *error = OWSErrorWithCodeDescription(OWSErrorCodeMessageRequestFailed,
        NSLocalizedString(@"XXGJUSTHHANQE36", @"Error indicating that a socket request failed."));
    ...
    if (!socketMessage) {
        ...
        if (didSucceed) {
            ...
            NSError *error = OWSErrorWithCodeDescription(OWSErrorCodeMessageResponseFailed,
                NSLocalizedString(
                    @"XXGJUSTHHANQE38", @"Error indicating that a socket response failed."));
