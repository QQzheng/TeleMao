...
class ContactViewController: OWSViewController, ContactShareViewHelperDelegate {
    ...
    private func createTopView() -> UIView {
        ...
        case .systemContactWithSignal:
            ...
            stackView.addArrangedSubview(createCircleActionButton(text: NSLocalizedString("XXGJUSTHHANQA11",
            ...
            if FeatureFlags.calling {
                stackView.addArrangedSubview(createCircleActionButton(text: NSLocalizedString("XXGJUSTHHANQA9",
                ...
                stackView.addArrangedSubview(createCircleActionButton(text: NSLocalizedString("XXGJUSTHHANQA13",
        ...
        case .systemContactWithoutSignal:
            let inviteButton = createLargePillButton(text: NSLocalizedString("XXGJUSTHHANQA10",
        ...
        let addToContactsButton = createLargePillButton(text: NSLocalizedString("XXGJUSTHHANQC120",
...
//           viewMode == .systemContactWithoutSignal {
//            addRow(createActionRow(labelText:NSLocalizedString("XXGJUSTHHANQA12",
...
//        }
    ...
    func didPressPhoneNumber(phoneNumber: OWSContactPhoneNumber) {
        ...
        if let e164 = phoneNumber.tryToConvertToE164() {
            ...
            if contactShare.systemContactsWithSignalAccountPhoneNumbers(contactsManager).contains(e164) {
                actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQA11",
                                                                             comment: "Label for 'send message' button in contact view."),
                                                    style: .default) { _ in
                                                        SignalApp.shared().presentConversation(for: address, action: .compose, animated: true)
                })
                actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQA9",
                                                                             comment: "Label for 'audio call' button in contact view."),
                                                    style: .default) { _ in
                                                        SignalApp.shared().presentConversation(for: address, action: .audioCall, animated: true)
                })
                actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQA13",
                                                                             comment: "Label for 'video call' button in contact view."),
                                                    style: .default) { _ in
        ...
        actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQE8",
    ...
    func didPressEmail(email: OWSContactEmail) {
        ...
        let actionSheet = ActionSheetController(title: nil, message: nil)
        actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQC82",
    ...
    func didPressAddress(address: OWSContactAddress) {
        ...
        let actionSheet = ActionSheetController(title: nil, message: nil)
        actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQC81",
