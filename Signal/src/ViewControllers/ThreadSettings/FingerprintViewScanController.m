...
- (void)loadView
{
    ...
    self.title = NSLocalizedString(@"XXGJUSTHHANQS7", @"Title for the 'scan QR code' view.");
...
- (void)createViews
{
    ...
    cameraInstructionLabel.text
        = NSLocalizedString(@"XXGJUSTHHANQS6", @"label presented once scanning (camera) view is visible.");
                              ...
                              tag:(NSString *)tag
{
    ...
    NSString *successTitle = NSLocalizedString(@"XXGJUSTHHANQS177", nil);
    NSString *descriptionFormat = NSLocalizedString(
        @"XXGJUSTHHANQS176", @"Alert body after verifying privacy with {{other user's name}}");
    ...
    [alert addAction:[[ActionSheetAction alloc]
                         initWithTitle:NSLocalizedString(@"XXGJUSTHHANQF4",
                                    ...
                                    tag:(NSString *)tag
{
    ...
    if (error.code != OWSErrorCodeUserError) {
        failureTitle = NSLocalizedString(@"XXGJUSTHHANQF3", @"alert title");
