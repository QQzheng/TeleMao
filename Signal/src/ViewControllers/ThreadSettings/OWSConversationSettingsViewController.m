...
- (void)configureWithThread:(TSThread *)thread
{
    ...
    if ([self.thread isKindOfClass:[TSContactThread class]]) {
        self.title = NSLocalizedString(
            @"XXGJUSTHHANQC98", @"Navbar title when viewing settings for a 1-on-1 thread");
    } else {
        self.title = NSLocalizedString(
            @"XXGJUSTHHANQC100", @"Navbar title when viewing settings for a group thread");
    }
}
...
- (void)updateTableContents
{
    ...
    contents.title = NSLocalizedString(@"XXGJUSTHHANQC94", @"title for conversation settings screen");
    ...
    if ([self.thread isKindOfClass:[TSContactThread class]] && self.contactsManager.supportsContactEditing
        ...
        [mainSection addItem:[OWSTableItem
                                 itemWithCustomCellBlock:^{
                                     return [weakSelf
                                          disclosureCellWithName:
                                              NSLocalizedString(@"XXGJUSTHHANQC134",
                                 ...
                                 actionBlock:^{
                                     ...
                                     NSString *createNewTitle = NSLocalizedString(@"XXGJUSTHHANQC110",
                                     ...
                                     NSString *addToExistingTitle = NSLocalizedString(@"XXGJUSTHHANQC95",
                                                                                      @"Label for 'new contact' button in conversation settings view.");
                                     [actionSheet
                                         addAction:[[ActionSheetAction alloc]
                                ...
                                NSString *cancelTitle = NSLocalizedString(@"XXGJUSTHHANQT19",
                                                                                 @"取消该操作");
                                [actionSheet
                                    addAction:[[ActionSheetAction alloc]
                                                  initWithTitle:cancelTitle
    ...
    if (SSKFeatureFlags.conversationSearch) {
        [mainSection addItem:[OWSTableItem
                                 itemWithCustomCellBlock:^{
                                     NSString *title = NSLocalizedString(@"XXGJUSTHHANQC111",
    ...
    if (!isNoteToSelf && !self.isGroupThread && self.thread.hasSafetyNumbers) {
        [mainSection
            addItem:[OWSTableItem
                        itemWithCustomCellBlock:^{
                            return [weakSelf
                                 disclosureCellWithName:NSLocalizedString(@"XXGJUSTHHANQV8",
            ...
            addItem:[OWSTableItem
                        itemWithCustomCellBlock:^{
                            ...
                            UITableViewCell *cell = [strongSelf
                                 disclosureCellWithName:
                                     (strongSelf.isGroupThread
                                             ? NSLocalizedString(@"XXGJUSTHHANQC118",
    ...
    [mainSection addItem:[OWSTableItem
                             itemWithCustomCellBlock:^{
                                 ...
                                 rowLabel.text = NSLocalizedString(
                                     @"XXGJUSTHHANQD27", @"table cell label in conversation settings");
                                 ...
                                 subtitleLabel.text = NSLocalizedString(
                                     @"XXGJUSTHHANQD29", @"subheading in conversation settings");
    ...
    [mainSection
        addItem:[OWSTableItem
                    itemWithCustomCellBlock:^{
                        ...
                        NSString *title = NSLocalizedString(@"XXGJUSTHHANQC99",
    ...
    if (self.isGroupThread) {
        NSArray *groupItems = @[
            [OWSTableItem
                itemWithCustomCellBlock:^{
                    UITableViewCell *cell =
                        [weakSelf disclosureCellWithName:NSLocalizedString(@"XXGJUSTHHANQE3",
            ...
            [OWSTableItem
                itemWithCustomCellBlock:^{
                    UITableViewCell *cell =
                        [weakSelf disclosureCellWithName:NSLocalizedString(@"XXGJUSTHHANQL14",
                                                             @"table cell label in conversation settings")
            ...
            [OWSTableItem
                itemWithCustomCellBlock:^{
                    UITableViewCell *cell =
                        [weakSelf disclosureCellWithName:NSLocalizedString(@"XXGJUSTHHANQL2",
                                                             @"table cell label in conversation settings")
        ...
        [contents addSection:[OWSTableSection sectionWithTitle:NSLocalizedString(@"XXGJUSTHHANQG18",
    ...
    if (!isNoteToSelf) {
        ...
        notificationsSection.headerTitle = NSLocalizedString(
            @"XXGJUSTHHANQS124", @"Label for the notifications section of conversation settings view.");
        ...
        [notificationsSection
            addItem:[OWSTableItem
                        itemWithCustomCellBlock:^{
                            ...
                            UILabel *rowLabel = [UILabel new];
                            rowLabel.text = NSLocalizedString(@"XXGJUSTHHANQS94",
            ...
            addItem:
                [OWSTableItem
                    itemWithCustomCellBlock:^{
                        ...
                        UILabel *rowLabel = [UILabel new];
                        rowLabel.text = NSLocalizedString(@"XXGJUSTHHANQC14",
                            @"label for 'mute thread' cell in conversation settings");
                        rowLabel.textColor = Theme.primaryTextColor;
                        rowLabel.font = [UIFont ows_dynamicTypeBodyFont];
                        rowLabel.lineBreakMode = NSLineBreakByTruncatingTail;

                        NSString *muteStatus = NSLocalizedString(@"XXGJUSTHHANQC103",
                        ...
                        if (mutedUntilDate != nil && [mutedUntilDate timeIntervalSinceDate:now] > 0) {
                            ...
                            muteStatus = [NSString
                                stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQC109",
        ...
        notificationsSection.footerTitle = NSLocalizedString(
            @"XXGJUSTHHANQM66", @"An explanation of the consequences of muting a thread.");
    ...
    if (!isNoteToSelf) {
        ...
        if (self.thread.isGroupThread) {
            section.footerTitle = NSLocalizedString(
                @"XXGJUSTHHANQB21", @"An explanation of the consequences of blocking a group.");
        } else {
            section.footerTitle = NSLocalizedString(
                @"XXGJUSTHHANQB41", @"An explanation of the consequences of blocking another user.");
        }
        ...
        [section addItem:[OWSTableItem
                             itemWithCustomCellBlock:^{
                                 ...
                                 if (strongSelf.thread.isGroupThread) {
                                     cellTitle = NSLocalizedString(@"XXGJUSTHHANQC96",
                                         @"table cell label in conversation settings");
                                 } else {
                                     cellTitle = NSLocalizedString(@"XXGJUSTHHANQC97",
                                         @"table cell label in conversation settings");
                                 }
                                 UITableViewCell *cell = [strongSelf
...
//#endif
        ...
        if (isVerified) {
            ...
            [subtitle appendAttributedString:[[NSAttributedString alloc]
                                                 initWithString:NSLocalizedString(@"XXGJUSTHHANQP67",
...
- (void)didTapLeaveGroup
{
    ActionSheetController *alert = [[ActionSheetController alloc]
        initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC49", @"Alert title")
              message:NSLocalizedString(@"XXGJUSTHHANQC48", @"Alert body")];

    ActionSheetAction *leaveAction = [[ActionSheetAction alloc]
                  initWithTitle:NSLocalizedString(@"XXGJUSTHHANQL1", @"Confirmation button within contextual alert")
...
{
    if (self.disappearingMessagesConfiguration.isEnabled) {
        NSString *keepForFormat = NSLocalizedString(@"XXGJUSTHHANQK1",
            @"Slider label embeds {{TIME_AMOUNT}}, e.g. '2 hours'. See *_TIME_AMOUNT strings for examples.");
        self.disappearingMessagesDurationLabel.text =
            [NSString stringWithFormat:keepForFormat, self.disappearingMessagesConfiguration.durationString];
    } else {
        self.disappearingMessagesDurationLabel.text
            = NSLocalizedString(@"XXGJUSTHHANQK2", @"Slider label when disappearing messages is off");
    }
...
- (void)showMuteUnmuteActionSheet
{
    ...
    if (!self.thread.isMuted) {
        title = NSLocalizedString(
            @"XXGJUSTHHANQC14", @"Title of the 'mute this thread' action sheet.");
    ...
    if (self.thread.isMuted) {
        ActionSheetAction *action =
            [[ActionSheetAction alloc] initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC113",
...
//        [actionSheet
//            addAction:[[ActionSheetAction alloc]
//                                    initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC106",
...
//#endif
        [actionSheet
            addAction:[[ActionSheetAction alloc]
                                    initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC105",
        ...
        [actionSheet
            addAction:[[ActionSheetAction alloc]
                                    initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC104",
        ...
        [actionSheet
            addAction:[[ActionSheetAction alloc]
                                    initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC107",
        ...
        [actionSheet
            addAction:[[ActionSheetAction alloc]
                                    initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC108",
...
- (void)showColorPicker
{
    ...
    [self presentFullScreenViewController:sheetViewController
                       animated:YES
                     completion:^() {
