...
- (void)updateTableContents
{
    ...
    if (noLongerVerifiedRecipientAddresses.count > 0) {
        ...
        noLongerVerifiedSection.headerTitle = NSLocalizedString(@"XXGJUSTHHANQG24",
            @"Title for the 'no longer verified' section of the 'group members' view.");
        membersSection.headerTitle = NSLocalizedString(
            @"XXGJUSTHHANQG23", @"Title for the 'members' section of the 'group members' view.");
        [noLongerVerifiedSection
            addItem:[OWSTableItem disclosureItemWithText:NSLocalizedString(@"XXGJUSTHHANQG21",
        ...
        [section addItem:[OWSTableItem
                             itemWithCustomCellBlock:^{
                                 ...
                                 if (isNoLongerVerified) {
                                     cell.accessoryMessage = NSLocalizedString(@"XXGJUSTHHANQC56",
...
- (void)offerResetAllNoLongerVerified
{
    ...
    ActionSheetController *actionSheet = [[ActionSheetController alloc]
        initWithTitle:nil
              message:NSLocalizedString(@"XXGJUSTHHANQG22",
