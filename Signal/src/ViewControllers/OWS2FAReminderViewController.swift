...
public class OWS2FAReminderViewController: UIViewController, PinEntryViewDelegate {
    ...
    override public func loadView() {
        ...
        self.navigationItem.title = NSLocalizedString("XXGJUSTHHANQR46", comment: "Navbar title for when user is periodically prompted to enter their registration lock PIN")
        ...
        let instructionsTextHeader = NSLocalizedString("XXGJUSTHHANQR44", comment: "Body header for when user is periodically prompted to enter their registration lock PIN")
        let instructionsTextBody = NSLocalizedString("XXGJUSTHHANQR43", comment: "Body text for when user is periodically prompted to enter their registration lock PIN")
    ...
    public func pinEntryViewForgotPinLinkTapped(_ entryView: PinEntryView) {
        Logger.info("")
        let alertBody = NSLocalizedString("XXGJUSTHHANQR45",
    ...
    private func didSubmitWrongPin() {
        ...
        Logger.info("")
        let alertTitle = NSLocalizedString("XXGJUSTHHANQR48",
                                          comment: "Alert title after wrong guess for 'two-factor auth pin' reminder activity")
        let alertBody = NSLocalizedString("XXGJUSTHHANQR47",
