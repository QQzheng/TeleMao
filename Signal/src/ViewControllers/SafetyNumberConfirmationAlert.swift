...
public class SafetyNumberConfirmationAlert: NSObject {
    ...
    public func presentIfNecessary(addresses: [SignalServiceAddress], confirmationText: String, completion: @escaping (Bool) -> Void, beforePresentationHandler: (() -> Void)? = nil) -> Bool {
        ...
        let titleFormat = NSLocalizedString("XXGJUSTHHANQC52",
        ...
        let bodyFormat = NSLocalizedString("XXGJUSTHHANQC51",
        ...
        let showSafetyNumberAction = ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQV8", comment: "Label for button or row which allows users to verify the safety number of another user."), style: .default) { _ in
