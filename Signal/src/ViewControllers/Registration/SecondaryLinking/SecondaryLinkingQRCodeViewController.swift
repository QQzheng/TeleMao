...
public class SecondaryLinkingQRCodeViewController: OnboardingBaseViewController {
    ...
    override public func loadView() {
        ...
        let titleLabel = self.titleLabel(text: NSLocalizedString("XXGJUSTHHANQS35", comment: "header text while displaying a QR code which, when scanned, will link this device."))
        primaryView.addSubview(titleLabel)
        titleLabel.accessibilityIdentifier = "onboarding.linking.titleLabel"
        titleLabel.setContentHuggingHigh()

        let bodyLabel = self.titleLabel(text: NSLocalizedString("XXGJUSTHHANQS33", comment: "body text while displaying a QR code which, when scanned, will link this device."))
        ...
        explanationLabel.text = NSLocalizedString("XXGJUSTHHANQS34",
    ...
    public func fetchAndSetQRCode() {
        ...
        provisioningController.getProvisioningURL().done { url in
            ...
            let title = NSLocalizedString("XXGJUSTHHANQS21", comment: "alert title")
