...
public class OnboardingCountryState: NSObject {
    ...
    public static var defaultValue: OnboardingCountryState {
        ...
        var countryName = NSLocalizedString("XXGJUSTHHANQU4", comment: "Label for unknown countries.")
...
public class OnboardingController: NSObject {
    ...
    @objc
    //版本1.0 UI OnboardingSplashViewController -> OnboardingPermissionsViewController
    private(set) lazy var initialViewController = OnboardingPermissionsViewController(onboardingController: self)
...
//        }
    ...
    private func showBackupCheckFailedAlert(fromView view: UIViewController) {
        ...
        let alert = ActionSheetController(title: NSLocalizedString("XXGJUSTHHANQA19",
        ...
        alert.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQR23", comment: ""),
                                      style: .default) { (_) in
                                        self.checkCanImportBackup(fromView: view)
        })
        alert.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQC30", comment: "The label for the 'do not restore backup' button."),
    ...
    private func requestingVerificationDidFail(viewController: UIViewController, error: Error) {
        ...
        case let networkManagerError as NetworkManagerError:
            ...
            case 400:
                OWSActionSheets.showActionSheet(title: NSLocalizedString("XXGJUSTHHANQR29", comment: ""),
                                    message: NSLocalizedString("XXGJUSTHHANQR31", comment: ""))
                return
            default:
                break
            }
    ...
    private func verificationFailed(fromViewController: UIViewController, error: NSError,
        ...
        if error.domain == OWSSignalServiceKitErrorDomain &&
            ...
            OWSActionSheets.showActionSheet(title: NSLocalizedString("XXGJUSTHHANQR34", comment: "Alert view title"),
