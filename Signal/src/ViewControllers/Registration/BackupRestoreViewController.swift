...
public class BackupRestoreViewController: OWSTableViewController {
    ...
    override public func loadView() {
        ...
        navigationItem.title = NSLocalizedString("XXGJUSTHHANQS65", comment: "Label for the backup view in app settings.")
    ...
    private func updateDecisionContents() {
        ...
        section.headerTitle = NSLocalizedString("XXGJUSTHHANQB16", comment: "Label for the backup restore decision section.")

        section.add(OWSTableItem.actionItem(withText: NSLocalizedString("XXGJUSTHHANQC30",
        ...
        section.add(OWSTableItem.actionItem(withText: NSLocalizedString("XXGJUSTHHANQC32",
    ...
    private func updateProgressContents() {
        ...
        section.add(OWSTableItem.label(withText: NSLocalizedString("XXGJUSTHHANQB19", comment: "Label for the backup restore status."), accessoryText: NSStringForBackupImportState(backup.backupImportState)))

        if backup.backupImportState == .inProgress {
            if let backupImportDescription = backup.backupImportDescription {
                section.add(OWSTableItem.label(withText: NSLocalizedString("XXGJUSTHHANQB17", comment: "Label for the backup restore description."), accessoryText: backupImportDescription))
            }
            ...
            if let backupImportProgress = backup.backupImportProgress {
                ...
                if let progressString = progressFormatter.string(from: NSNumber(value: progressInt)) {
                    section.add(OWSTableItem.label(withText: NSLocalizedString("XXGJUSTHHANQB18", comment: "Label for the backup restore progress."), accessoryText: progressString))
                } else {
