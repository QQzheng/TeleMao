...
public class OnboardingVerificationViewController: OnboardingBaseViewController {
    ...
    override public func loadView() {
        ...
        let backLink = self.linkButton(title: NSLocalizedString("XXGJUSTHHANQO32",
        ...
        errorLabel.text = NSLocalizedString("XXGJUSTHHANQO35",
    ...
    private func updateCodeState() {
        ...
        case .sent, .readyForResend:
            titleLabel.text = String(format: NSLocalizedString("XXGJUSTHHANQO42",
                                                               comment: "Format for the title of the 'onboarding verification' view. Embeds {{the user's phone number}}."),
                                     formattedPhoneNumber)
        case .resent:
            titleLabel.text = String(format: NSLocalizedString("XXGJUSTHHANQO43",
        ...
        case .sent:
            ...
            let text = String(format: NSLocalizedString("XXGJUSTHHANQO33",
...
//版本1.1 新增交互控制3行 isUserInteractionEnabled
            codeStateLink.isUserInteractionEnabled = false
        case .readyForResend:
            codeStateLink.setTitle(title: NSLocalizedString("XXGJUSTHHANQO36",
             ...
             codeStateLink.isUserInteractionEnabled = true
        case .resent:
            codeStateLink.setTitle(title: NSLocalizedString("XXGJUSTHHANQO41",
    ...
    private func showResendActionSheet() {
        ...
        let actionSheet = ActionSheetController(title: NSLocalizedString("XXGJUSTHHANQO38",
                                                                     comment: "Title for the 'resend code' alert in the 'onboarding verification' view."),
                                            message: NSLocalizedString("XXGJUSTHHANQO37",
        ...
        if onboardingController.verificationRequestCount > 2 {
            actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQO34",
                                                ...
                                                style: .default) { _ in
                                                    Pastelog.submitEmail(logUrl: nil,
                                                                         subject: "Tmao Registration - Verification Code for iOS")
            })
        }

        actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQO39",
        ...
        actionSheet.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQO40",
