...
public class OnboardingSplashViewController: OnboardingBaseViewController {
    ...
    override public func loadView() {
        ...
        let titleLabel = self.titleLabel(text: NSLocalizedString("XXGJUSTHHANQO31", comment: "Title of the 'onboarding splash' view."))
        primaryView.addSubview(titleLabel)
        titleLabel.accessibilityIdentifier = "onboarding.splash." + "titleLabel"

        let explanationLabel = UILabel()
        explanationLabel.text = NSLocalizedString("XXGJUSTHHANQO30",
        ...
        let continueButton = self.button(title: CommonStrings.continueButton,
