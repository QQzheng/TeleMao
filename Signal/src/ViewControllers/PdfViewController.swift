...
public class PdfViewController: OWSViewController {
    ...
    public override func viewDidLoad() {
        ...
        navigationItem.title = NSLocalizedString("XXGJUSTHHANQP2", comment: "Navbar title for for PDF view.")
        ...
        // Otherwise, render an error
            ...
            let label = UILabel()
            contentView = label
            label.text = NSLocalizedString("XXGJUSTHHANQP1", comment: "Error indicating that a PDF could not be displayed.")
