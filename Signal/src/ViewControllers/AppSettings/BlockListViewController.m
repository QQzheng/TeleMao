...
- (void)updateTableContents
{
    ...
    [addSection
        addItem:[OWSTableItem
                     disclosureItemWithText:NSLocalizedString(@"XXGJUSTHHANQS79",
    ...
    if (blockedAddresses.count > 0) {
        ...
        blockedContactsSection.headerTitle = NSLocalizedString(
            @"XXGJUSTHHANQB26", @"Section header for users that have been blocked");
    ...
    if (blockedGroups.count > 0) {
        ...
        blockedGroupsSection.headerTitle = NSLocalizedString(
            @"XXGJUSTHHANQB25", @"Section header for groups that have been blocked");
