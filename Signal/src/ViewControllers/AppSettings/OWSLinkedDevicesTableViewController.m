...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedString(@"XXGJUSTHHANQL12", @"Menu item and navbar title for the device manager");
...
- (void)expectMoreDevices
{
    ...
    NSString *progressText = NSLocalizedString(@"XXGJUSTHHANQW1",
...
- (void)deviceListUpdateFailed:(NSNotification *)notification
{
    ...
    NSString *alertTitle = NSLocalizedString(
        @"XXGJUSTHHANQD26", @"Alert title that can occur when viewing device manager.");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == OWSLinkedDevicesTableViewControllerSectionAddDevice) {
        ...
        cell.textLabel.text
            = NSLocalizedString(@"XXGJUSTHHANQL10", @"Navigation title when scanning QR code to add new device.");
        cell.detailTextLabel.text
            = NSLocalizedString(@"XXGJUSTHHANQL9", @"Subheading for 'Link New Device' navigation");
...
{
    return NSLocalizedString(@"XXGJUSTHHANQU13", "button title for unlinking a device");
}
...
- (void)touchedUnlinkControlForDevice:(OWSDevice *)device success:(void (^)(void))successCallback
{
    NSString *confirmationTitleFormat
        = NSLocalizedString(@"XXGJUSTHHANQU15", @"Alert title for confirming device deletion");
    NSString *confirmationTitle = [NSString stringWithFormat:confirmationTitleFormat, device.displayName];
    NSString *confirmationMessage
        = NSLocalizedString(@"XXGJUSTHHANQU14", @"Alert message to confirm unlinking a device");
    ...
    ActionSheetAction *unlinkAction = [[ActionSheetAction alloc]
        initWithTitle:NSLocalizedString(@"XXGJUSTHHANQU13", "button title for unlinking a device")
    ...
    [OWSDevicesService unlinkDevice:device
                            ...
                            failure:^(NSError *error) {
                                NSString *title = NSLocalizedString(
                                    @"XXGJUSTHHANQU17", @"Alert title when unlinking device fails");
