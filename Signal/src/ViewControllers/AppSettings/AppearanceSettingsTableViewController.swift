...
class AppearanceSettingsTableViewController: OWSTableViewController {
    override func viewDidLoad() {
        ...
        title = NSLocalizedString("XXGJUSTHHANQS63", comment: "The title for the appearance settings.")
    ...
    func updateTableContents() {
        ...
        themeSection.headerTitle = NSLocalizedString("XXGJUSTHHANQS62",
    ...
    func nameForTheme(_ mode: ThemeMode) -> String {
        switch mode {
        case .dark:
            return NSLocalizedString("XXGJUSTHHANQA33", comment: "Name indicating that the dark theme is enabled.")
        case .light:
            return NSLocalizedString("XXGJUSTHHANQA34", comment: "Name indicating that the light theme is enabled.")
        case .system:
            return NSLocalizedString("XXGJUSTHHANQA35", comment: "Name indicating that the system theme is enabled.")
        }
    }
}
