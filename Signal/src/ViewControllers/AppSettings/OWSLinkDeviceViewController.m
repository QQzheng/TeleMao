...
- (void)viewDidLoad
{
    ...
    self.scanningInstructionsLabel.text = NSLocalizedString(@"XXGJUSTHHANQL8",
...
- (void)controller:(OWSQRCodeScanningViewController *)controller didDetectQRCodeWithString:(NSString *)string
{
    ...
    if (!parser.isValid) {
        ...
        NSString *title = NSLocalizedString(@"XXGJUSTHHANQL4", @"report an invalid linking code");
        NSString *body = NSLocalizedString(@"XXGJUSTHHANQL3", @"report an invalid linking code");
        ...
        ActionSheetAction *proceedAction = [[ActionSheetAction alloc]
            initWithTitle:NSLocalizedString(@"XXGJUSTHHANQL7", @"attempt another linking")
        ...
        NSString *title = NSLocalizedString(
            @"XXGJUSTHHANQL6", @"confirm the users intent to link a new device");
        NSString *linkingDescription
            = NSLocalizedString(@"XXGJUSTHHANQL5", @"confirm the users intent to link a new device");
        ...
        ActionSheetAction *proceedAction = [[ActionSheetAction alloc]
            initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC50", @"Button text")
                    style:ActionSheetActionStyleDefault
                  handler:^(ActionSheetAction *action) {
...
{
    NSString *title = NSLocalizedString(@"XXGJUSTHHANQL13", @"Alert Title");
    ActionSheetController *actionSheet = [[ActionSheetController alloc] initWithTitle:title
