...
class CallViewController: OWSViewController, CallObserver, CallServiceObserver, CallAudioServiceDelegate {
    ...
    func createSettingsNagViews() {
        ...
        settingsNagDescriptionLabel.text = NSLocalizedString("XXGJUSTHHANQC15",
        ...
        let callSettingsButton = OWSFlatButton.button(title: NSLocalizedString("XXGJUSTHHANQC17",
        ...
        let notNowButton = OWSFlatButton.button(title: NSLocalizedString("XXGJUSTHHANQA0",
    ...
    func createOngoingCallControls() {
        ...
        audioSourceButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQA3",
        ...
        hangUpButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQC13",
        ...
        audioModeMuteButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQC14",
        ...
        audioModeVideoButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQC20", comment: "Accessibility label to switch to video call")
        ...
        videoModeMuteButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQC14", comment: "Accessibility label for muting the microphone")
        ...
        videoModeFlipCameraButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQC18", comment: "Accessibility label to toggle front- vs. rear-facing camera")
        ...
        videoModeVideoButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQC19", comment: "Accessibility label to switch to audio only")
    ...
    func createIncomingCallControls() {
        ...
        acceptIncomingButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQC9",
        ...
        declineIncomingButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQC11",
    ...
    func localizedTextForCallState(_ callState: CallState) -> String {
        ...
        case .idle, .remoteHangup, .localHangup:
            return NSLocalizedString("XXGJUSTHHANQI7", comment: "Call setup status label")
        case .dialing:
            return NSLocalizedString("XXGJUSTHHANQI3", comment: "Call setup status label")
        case .remoteRinging, .localRinging:
            return NSLocalizedString("XXGJUSTHHANQI5", comment: "Call setup status label")
        case .answering:
            return NSLocalizedString("XXGJUSTHHANQI6", comment: "Call setup status label")
        case .connected:
        ...
        case .reconnecting:
            return NSLocalizedString("XXGJUSTHHANQI4", comment: "Call setup status label")
        case .remoteBusy:
            return NSLocalizedString("XXGJUSTHHANQE26", comment: "Call setup status label")
        case .localFailure:
            if let error = call.error {
                switch error {
                case .timeout(description: _):
                    if self.call.direction == .outgoing {
                        return NSLocalizedString("XXGJUSTHHANQC4", comment: "Call setup status label after outgoing call times out")
                    }
                default:
                    break
                }
            ...
            return NSLocalizedString("XXGJUSTHHANQE27", comment: "Call setup status label")
        }
    }
    ...
    internal func dismissIfPossible(shouldDelay: Bool, ignoreNag ignoreNagParam: Bool = false, completion: (() -> Void)? = nil) {
        ...
        if hasDismissed {
            ...
            if Environment.shared.preferences.isCallKitEnabled() {
                settingsNagDescriptionLabel.text = NSLocalizedString("XXGJUSTHHANQC16",
