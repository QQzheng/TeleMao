...
class MediaPageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate, MediaDetailViewControllerDelegate, MediaGalleryDelegate {
    ...
    public func didPressDelete(_ sender: Any) {
        ...
        let deleteAction = ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQT20", comment: ""),
    ...
    private func senderName(message: TSMessage) -> String {
        ...
        case is TSOutgoingMessage:
            return NSLocalizedString("XXGJUSTHHANQA7", comment: "Short sender label for media sent by you")
        default:
