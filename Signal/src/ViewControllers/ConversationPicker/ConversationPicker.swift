...
extension ConversationPickerViewController: UITableViewDelegate {
    ...
    private func showTooManySelectedToast() {
        ...
        let toastFormat = NSLocalizedString("XXGJUSTHHANQC86",
...
extension ConversationPickerViewController {
    private struct Strings {
        static let title = NSLocalizedString("XXGJUSTHHANQC90", comment: "navbar header")
        static let recentsSection = NSLocalizedString("XXGJUSTHHANQC87", comment: "table section header for section containing recent conversations")
        static let signalContactsSection = NSLocalizedString("XXGJUSTHHANQC88", comment: "table section header for section containing contacts")
        static let groupsSection = NSLocalizedString("XXGJUSTHHANQC42", comment: "table section header for section containing groups")
    }
}
