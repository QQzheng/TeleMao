...
class AttachmentFormatCell: UICollectionViewCell {
    ...
    public func configure(type: AttachmentType, cameraPreview: CapturePreviewView?) {
        ...
        switch type {
        case .camera:
            text = NSLocalizedString("XXGJUSTHHANQA60", comment: "A button to open the camera from the Attachment Keyboard")
            imageName = Theme.iconName(.attachmentCamera)
        case .contact:
            text = NSLocalizedString("XXGJUSTHHANQA4", comment: "A button to select a contact from the Attachment Keyboard")
            imageName = Theme.iconName(.attachmentContact)
        case .file:
            text = NSLocalizedString("XXGJUSTHHANQA62", comment: "A button to select a file from the Attachment Keyboard")
            imageName = Theme.iconName(.attachmentFile)
        case .gif:
            text = NSLocalizedString("XXGJUSTHHANQA63", comment: "A button to select a GIF from the Attachment Keyboard")
            imageName = Theme.iconName(.attachmentGif)
        case .location:
            text = NSLocalizedString("XXGJUSTHHANQA64", comment: "A button to select a location from the Attachment Keyboard")
