...
class UsernameViewController: OWSViewController {
    ...
    override func viewDidLoad() {
        ...
        title = NSLocalizedString("XXGJUSTHHANQU42", comment: "The title for the username view.")
        ...
        titleLabel.text = NSLocalizedString("XXGJUSTHHANQU34", comment: "Label for the username field in the username view.")
        ...
        usernameTextField.placeholder = NSLocalizedString("XXGJUSTHHANQU39",
        ...
        infoLabel.text = NSLocalizedString("XXGJUSTHHANQU33", comment: "An explanation of how usernames work on the username view.")
    ...
    func updateValidationError() {
        ...
        case .tooShort:
            ...
            errorLabel.text = NSLocalizedString("XXGJUSTHHANQU43",
                                                comment: "An error indicating that the supplied username is too short.")
        case .invalidCharacters:
            errorRow.isHidden = false
            errorLabel.text = NSLocalizedString("XXGJUSTHHANQU35",
                                                comment: "An error indicating that the supplied username contains disallowed characters.")
        case .inUse:
            errorRow.isHidden = false

            let unavailableErrorFormat = NSLocalizedString("XXGJUSTHHANQU44",
        ...
        case .startsWithNumber:
            errorRow.isHidden = false
            errorLabel.text = NSLocalizedString("XXGJUSTHHANQU41",
    ...
    func saveUsername() {
        ...
        ModalActivityIndicatorViewController.present(fromViewController: self, canCancel: false) { modalView in
            ...
            SSKEnvironment.shared.networkManager.makePromise(request: usernameRequest).done { _ in
                ...
                modalView.dismiss {
                    OWSActionSheets.showErrorAlert(message: NSLocalizedString("XXGJUSTHHANQU45",
