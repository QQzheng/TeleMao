...
class MessageDetailViewController: OWSViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = NSLocalizedString("XXGJUSTHHANQM30",
    ...
    private func updateContent() {
        ...
        if let incomingMessage = message as? TSIncomingMessage {
            ...
            rows.append(valueRow(name: NSLocalizedString("XXGJUSTHHANQM27",
        ...
        let sentRow: UIStackView = valueRow(name: NSLocalizedString("XXGJUSTHHANQM28",
        ...
        if message is TSIncomingMessage {
            rows.append(valueRow(name: NSLocalizedString("XXGJUSTHHANQM26",
    ...
    private func contentRows() -> [UIView] {
        ...
        if rows.isEmpty {
            ...
            rows.append(valueRow(name: NSLocalizedString("XXGJUSTHHANQM25",
    ...
    private func addAttachmentMetadataRows() -> [UIView] {
        ...
        if self.attachments?.count == 1, let attachment = self.attachments?.first {
            if let sourceFilename = attachment.sourceFilename {
                rows.append(valueRow(name: NSLocalizedString("XXGJUSTHHANQM29",
            ...
            if _isDebugAssertConfiguration() {
                ...
                rows.append(valueRow(name: NSLocalizedString("XXGJUSTHHANQM17",
                ...
                if let formattedByteCount = byteCountFormatter.string(for: attachment.byteCount) {
                    rows.append(valueRow(name: NSLocalizedString("XXGJUSTHHANQM16",
