...
- (void)loadView
{
    ...
    if (SSKFeatureFlags.usernames) {
        searchBar.placeholder = NSLocalizedString(@"XXGJUSTHHANQS17",
            @"Placeholder text indicating the user can search for contacts by name, username, or phone number.");
    } else {
        searchBar.placeholder = NSLocalizedString(@"XXGJUSTHHANQS18",
...
- (UIView *)createNoSignalContactsView
{
    ...
    titleLabel.text = NSLocalizedString(
        @"XXGJUSTHHANQE11", "Full width label displayed when attempting to compose message");
    ...
    subtitleLabel.text = NSLocalizedString(
        @"XXGJUSTHHANQE12", "Full width label displayed when attempting to compose message");
    ...
    if (self.shouldShowInvites) {
        ...
        [inviteContactsButton setTitle:NSLocalizedString(@"XXGJUSTHHANQI21",
    ...
    if (self.allowsAddByPhoneNumber) {
        ...
        [searchByPhoneNumberButton
            setTitle:NSLocalizedString(@"XXGJUSTHHANQN23",
...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedString(@"XXGJUSTHHANQK10", @"");
}
...
- (void)updateTableContents
{
        ...
        OWSTableItem *contactReminderItem = [OWSTableItem
            itemWithCustomCellBlock:^{
                ...
                ReminderView *reminderView = [ReminderView
                    nagWithText:NSLocalizedString(@"XXGJUSTHHANQC45",
    ...
    if (self.allowsAddByPhoneNumber) {
        [staticSection
            addItem:[OWSTableItem
                         disclosureItemWithText:NSLocalizedString(@"XXGJUSTHHANQN10",
    ...
    if (self.contactsManager.isSystemContactsAuthorized && self.shouldShowInvites) {
        ...
        [staticSection
            addItem:[OWSTableItem
                         disclosureItemWithText:NSLocalizedString(@"XXGJUSTHHANQI21",
                                                    @"Label for the cell that presents the 'invite contacts' workflow.")
                        accessibilityIdentifier:ACCESSIBILITY_IDENTIFIER_WITH_NAME(
    ...
    if (self.pickedRecipients.count > 0 && self.searchResults == nil) {
        ...
        if (hadNonContactRecipient) {
            staticSection.headerTitle = NSLocalizedString(@"XXGJUSTHHANQN19",
...
- (NSArray<OWSTableSection *> *)contactsSection
{
            ...
            if (self.contactsViewHelper.hasUpdatedContactsAtLeastOnce) {
                ...
                [contactsSection
                    addItem:[OWSTableItem softCenterLabelItemWithText:
                                              NSLocalizedString(@"XXGJUSTHHANQS80",
                                                  @"A label that indicates the user has no Tmao contacts.")
                                                      customRowHeight:UITableViewAutomaticDimension]];
            } else {
    ...
    if (self.shouldShowAlphabetSlider) {
        ...
        OWSTableSection *contactsSection = [OWSTableSection new];
        contactsSection.headerTitle = NSLocalizedString(@"XXGJUSTHHANQC41",
...
- (NSArray<OWSTableSection *> *)contactsSectionsForSearchResults:(ComposeScreenSearchResultSet *)searchResults
{
    ...
    if (self.shouldShowGroups) {
        ...
        groupSection.headerTitle = NSLocalizedString(@"XXGJUSTHHANQC42",
    ...
    phoneNumbersSection.headerTitle = NSLocalizedString(@"XXGJUSTHHANQC43",
    ...
    if (SSKFeatureFlags.usernames) {
        ...
        if (usernameMatch.length > 0 && ![startsWithNumberRegex hasMatchWithInput:usernameMatch]
            ...
            usernameSection.headerTitle = NSLocalizedString(@"XXGJUSTHHANQC44",
    ...
    if (!hasSearchResults) {
        ...
        [noResultsSection
            addItem:[OWSTableItem softCenterLabelItemWithText:
                                      NSLocalizedString(@"XXGJUSTHHANQS81",
...
- (void)sendTextToPhoneNumber:(NSString *)phoneNumber
{
    ...
    OWSAssertDebug([phoneNumber length] > 0);
    NSString *confirmMessage = NSLocalizedString(@"XXGJUSTHHANQS47", @"");
    if ([phoneNumber length] > 0) {
        confirmMessage = [[NSLocalizedString(@"XXGJUSTHHANQS48", @"") stringByAppendingString:phoneNumber]
            stringByAppendingString:NSLocalizedString(@"XXGJUSTHHANQQ1", @"")];
    }

    ActionSheetController *alert =
        [[ActionSheetController alloc] initWithTitle:NSLocalizedString(@"XXGJUSTHHANQC53", @"")
        ...
        accessibilityIdentifier:ACCESSIBILITY_IDENTIFIER_WITH_NAME(self, @"ok")
                        ...
                        handler:^(ActionSheetAction *action) {
                            ...
                            if ([MFMessageComposeViewController canSendText]) {
                                ...
                                [OWSActionSheets
                                    showErrorAlertWithMessage:NSLocalizedString(@"XXGJUSTHHANQU21", @"")];
                            }
                        }];
                 ...
                 didFinishWithResult:(MessageComposeResult)result
{
    switch (result) {
        ...
        case MessageComposeResultFailed: {
            [OWSActionSheets showErrorAlertWithMessage:NSLocalizedString(@"XXGJUSTHHANQS42", @"")];
            break;
        }
        case MessageComposeResultSent: {
            ...
            [OWSActionSheets showActionSheetWithTitle:NSLocalizedString(@"XXGJUSTHHANQS43",
                  ...
                  backgroundBlock:^(ModalActivityIndicatorViewController *modal) {
                      [self.contactsViewHelper.profileManager fetchAndUpdateProfileForUsername:username
                          ...
                          notFound:^{
                              ...
                              [modal dismissWithCompletion:^{
                                  NSString *usernameNotFoundFormat = NSLocalizedString(@"XXGJUSTHHANQU37",
                                      @"A message indicating that the given username is not a registered tmao "
                                      @"account. Embeds "
                                      @"{{username}}");
                                  [OWSActionSheets
                                      showActionSheetWithTitle:
                                          NSLocalizedString(@"XXGJUSTHHANQU38",
                                              @"A message indicating that the given username was not "
                                              @"registered with tmao.")
                          ...
                          failure:^(NSError *error) {
                              ...
                              [modal dismissWithCompletion:^{
                                  [OWSActionSheets showErrorAlertWithMessage:
                                                       NSLocalizedString(@"XXGJUSTHHANQU36",
