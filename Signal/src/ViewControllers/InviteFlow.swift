...
class InviteFlow: NSObject, MFMessageComposeViewControllerDelegate, MFMailComposeViewControllerDelegate, ContactsPickerDelegate {
    ...
    private func tweetAction() -> ActionSheetAction? {
        ...
        let tweetTitle = NSLocalizedString("XXGJUSTHHANQS144", comment: "action sheet item")
    ...
    private func presentInviteViaTwitterFlow() {
        ...
        let tweetString = NSLocalizedString("XXGJUSTHHANQS93", comment: "content of tweet when inviting via twitter - please do not translate URL")
    ...
    func contactsPicker(_: ContactsPicker, contactFetchDidFail error: NSError) {
        ...
        popToPresentingViewController(animated: true) {
            OWSActionSheets.showErrorAlert(message: NSLocalizedString("XXGJUSTHHANQE29", comment: "Error indicating that the phone's contacts could not be retrieved."))
        }
    }
    ...
    private func messageAction() -> ActionSheetAction? {
        ...
        let messageTitle = NSLocalizedString("XXGJUSTHHANQS143", comment: "action sheet item to open native messages app")
    ...
    private func presentInviteViaSMSFlow() {
        ...
        picker.title = NSLocalizedString("XXGJUSTHHANQI23", comment: "Navbar title")
        ...
        popToPresentingViewController(animated: true) {
            if phoneNumbers.count > 1 {
                let warning = ActionSheetController(title: nil,
                                                message: NSLocalizedString("XXGJUSTHHANQI24",
    ...
    private func mailAction() -> ActionSheetAction? {
        ...
        let mailActionTitle = NSLocalizedString("XXGJUSTHHANQS142", comment: "action sheet item to open native mail app")
    ...
    private func sendMailTo(emails recipientEmails: [String]) {
        ...
        let subject = NSLocalizedString("XXGJUSTHHANQE10", comment: "subject of email sent to contacts when inviting to install Tmao")
        let bodyFormat = NSLocalizedString("XXGJUSTHHANQE9", comment: "body of email sent to contacts when inviting to install Tmao. Embeds {{link to install Signal}} and {{link to the Signal home page}}")
