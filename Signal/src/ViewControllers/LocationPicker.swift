...
public class LocationPicker: UIViewController {
    ...
    private lazy var searchBar: UISearchBar = {
        ...
        searchBar.placeholder = NSLocalizedString("XXGJUSTHHANQL15",
    ...
    open override func viewDidLoad() {
        ...
        title = NSLocalizedString("XXGJUSTHHANQL16", comment: "The title for the location picker view")
    ...
    func requestAuthorization() {
        ...
        case .denied, .restricted:
            ...
            let alert = ActionSheetController(
                title: NSLocalizedString("XXGJUSTHHANQM61",
                                         comment: "Alert title indicating the user has denied location permissios"),
                message: NSLocalizedString("XXGJUSTHHANQM60",
    ...
    func selectLocation(location: CLLocation) {
        ...
        geocoder.reverseGeocodeLocation(location) { response, error in
            ...
            if let error = error, !geocodeCanceled {
                ...
                alert.addAction(ActionSheetAction(title: NSLocalizedString("XXGJUSTHHANQB45",
