...
public class PinSetupViewController: OWSViewController {
    ...
    override public func loadView() {
        ...
        if initialMode.isChanging {
            ...
            title = NSLocalizedString("XXGJUSTHHANQP29", comment: "Title of the 'pin creation' recreation view.")
        ...
        switch initialMode {
        case .recreating:
            titleLabel?.text = NSLocalizedString("XXGJUSTHHANQP41", comment: "Title of the 'pin creation' recreation view.")
        default:
            titleLabel?.text = NSLocalizedString("XXGJUSTHHANQP42", comment: "Title of the 'pin creation' view.")
        }
        ...
        case .creating, .changing:
            explanationLabel.text = NSLocalizedString("XXGJUSTHHANQP35",
                                                      comment: "The explanation in the 'pin creation' view.")
        case .recreating:
            explanationLabel.text = NSLocalizedString("XXGJUSTHHANQP40",
                                                      comment: "The re-creation explanation in the 'pin creation' view.")
        case .confirming:
            explanationLabel.text = NSLocalizedString("XXGJUSTHHANQP30",
    ...
    private func updateValidationWarnings() {
        ...
        case .tooShort:
            validationWarningLabel.text = NSLocalizedString("XXGJUSTHHANQP43",
                                                            comment: "Label indicating that the attempted PIN is too short")
        case .mismatch:
            validationWarningLabel.text = NSLocalizedString("XXGJUSTHHANQP36",
    ...
    private func updatePinType() {
        ...
        switch pinType {
        case .numeric:
            pinTypeToggle.setTitle(NSLocalizedString("XXGJUSTHHANQP31",
        ...
        if mode.isConfirming {
            ...
            recommendationLabel.text = NSLocalizedString("XXGJUSTHHANQP38",
    ...
    private func enable2FAAndContinue(withPin pin: String) {
        ...
        let progressView = ProgressView(
            loadingText: NSLocalizedString("XXGJUSTHHANQP39",
            ...
            progressView.loadingComplete(success: false, animateAlongside: {
                ...
                if case .creating = self.initialMode {
                    OWSActionSheets.showActionSheet(
                        title: NSLocalizedString("XXGJUSTHHANQP34",
                                                 comment: "Error title indicating that the attempt to create a PIN failed."),
                        message: NSLocalizedString("XXGJUSTHHANQP33",
                    ...
                    OWSActionSheets.showErrorAlert(
                        message: NSLocalizedString("XXGJUSTHHANQE15",
