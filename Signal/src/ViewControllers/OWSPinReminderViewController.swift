...
public class PinReminderViewController: OWSViewController {
    ...
    override public func loadView() {
        ...
        titleLabel.text = NSLocalizedString("XXGJUSTHHANQP54", comment: "The title for the 'pin reminder' dialog.")
        ...
        explanationLabel.text = NSLocalizedString("XXGJUSTHHANQP44", comment: "The explanation for the 'pin reminder' dialog.")
        ...
        let submitButton = OWSFlatButton.button(
            title: NSLocalizedString("XXGJUSTHHANQB47",
        ...
        forgotButton.setTitle(NSLocalizedString("XXGJUSTHHANQP45", comment: "Text asking if the user forgot their pin for the 'pin reminder' dialog."), for: .normal)
    ...
    private func updateValidationWarnings() {
        ...
        case .tooShort:
            validationWarningLabel.text = NSLocalizedString("XXGJUSTHHANQP55",
                                                            comment: "Label indicating that the attempted PIN is too short")
        case .mismatch:
            validationWarningLabel.text = NSLocalizedString("XXGJUSTHHANQP53",
