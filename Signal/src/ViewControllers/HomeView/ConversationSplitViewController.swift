...
private class NoSelectedConversationViewController: OWSViewController {
    ...
    override func loadView() {
        ...
        logoImageView.image = #imageLiteral(resourceName: "iconLaunch").withRenderingMode(.alwaysTemplate)
        ...
        titleLabel.text = NSLocalizedString("XXGJUSTHHANQN25", comment: "Title welcoming to the app")

        bodyLabel.font = .ows_dynamicTypeBody
        bodyLabel.textAlignment = .center
        bodyLabel.numberOfLines = 0
        bodyLabel.lineBreakMode = .byWordWrapping
        bodyLabel.text = NSLocalizedString("XXGJUSTHHANQN24", comment: "Explanation of how to see a conversation.")
