...
- (void)loadView
{
    ...
    self.title = NSLocalizedString(@"XXGJUSTHHANQP103", @"Title for the profile view.");
...
- (void)createViews
{
    ...
    void (^addGivenNameRow)(void) = ^{
        ...
        givenNameLabel.text = NSLocalizedString(
            @"XXGJUSTHHANQP98", @"Label for the given name field of the profile view.");
        ...
        givenNameTextField.placeholder = NSLocalizedString(
            @"XXGJUSTHHANQP97", @"Default text for the given name field of the profile view.");
    ...
    void (^addFamilyNameRow)(void) = ^{
        ...
        familyNameLabel.text = NSLocalizedString(
            @"XXGJUSTHHANQP96", @"Label for the family name field of the profile view.");
        ...
        familyNameTextField.placeholder = NSLocalizedString(
            @"XXGJUSTHHANQP95", @"Default text for the family name field of the profile view.");
    ...
    if (self.shouldShowUsernameRow) {
        ...
        usernameTitleLabel.text
            = NSLocalizedString(@"XXGJUSTHHANQP104", @"Label for the username field of the profile view.");
    ...
    [text appendAttributedString:[[NSAttributedString alloc]
                                     initWithString:NSLocalizedString(@"XXGJUSTHHANQP100",
    ...
    switch (self.profileViewMode) {
        ...
        case ProfileViewMode_ExperienceUpgrade: {
            ...
            OWSFlatButton *saveButton =
                [OWSFlatButton buttonWithTitle:NSLocalizedString(@"XXGJUSTHHANQA20",
...
- (void)updateProfile
{
    ...
    if (normalizedGivenName.length <= 0) {
        [OWSActionSheets showErrorAlertWithMessage:
                             NSLocalizedString(@"XXGJUSTHHANQP93",
    ...
    if ([OWSProfileManager.sharedManager isProfileNameTooLong:normalizedGivenName]) {
        [OWSActionSheets
            showErrorAlertWithMessage:NSLocalizedString(@"XXGJUSTHHANQP94",
    ...
    if ([OWSProfileManager.sharedManager isProfileNameTooLong:normalizedFamilyName]) {
        [OWSActionSheets
            showErrorAlertWithMessage:NSLocalizedString(@"XXGJUSTHHANQP92",
    ...
    if (!self.reachability.isReachable) {
        [OWSActionSheets
            showErrorAlertWithMessage:
                NSLocalizedString(@"XXGJUSTHHANQP99",
...
- (void)updateUsername
{
    ...
    if (username) {
        ...
        self.usernameLabel.text = NSLocalizedString(@"XXGJUSTHHANQP91",
...
- (void)usernameRowTapped:(UIGestureRecognizer *)sender
{
    ...
    if (self.profileViewMode == ProfileViewMode_Registration) {
        ...
        [self presentFullScreenViewController:[[OWSNavigationController alloc] initWithRootViewController:usernameVC]
                                    animated:YES
                                  completion:nil];
    } else {
...
- (nullable NSString *)avatarActionSheetTitle
{
    return NSLocalizedString(
        @"XXGJUSTHHANQP89", @"Action Sheet title prompting the user for a profile avatar");
}
...
{
    return NSLocalizedString(@"XXGJUSTHHANQP90", @"Label for action that clear's the user's profile avatar");
}
