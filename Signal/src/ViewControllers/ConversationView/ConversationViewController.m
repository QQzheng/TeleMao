...
- (void)ensureBannerState
{
    ...
    if (noLongerVerifiedAddresses.count > 0) {
        ...
        if (noLongerVerifiedAddresses.count > 1) {
            message = NSLocalizedString(@"XXGJUSTHHANQM55",
    ...
    if ([self isBlockedConversation]) {
        if (self.isGroupConversation) {
            blockStateMessage = NSLocalizedString(
                @"XXGJUSTHHANQM53", @"Indicates that this group conversation has been blocked.");
        } else {
            blockStateMessage = NSLocalizedString(
                @"XXGJUSTHHANQM50", @"Indicates that this 1:1 conversation has been blocked.");
        }
    } else if (self.isGroupConversation) {
        int blockedGroupMemberCount = [self blockedGroupMemberCount];
        if (blockedGroupMemberCount == 1) {
            blockStateMessage = NSLocalizedString(@"XXGJUSTHHANQM52",
                @"Indicates that a single member of this group has been blocked.");
        } else if (blockedGroupMemberCount > 1) {
            blockStateMessage =
                [NSString stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQM54",
...
- (void)noLongerVerifiedBannerViewWasTapped:(UIGestureRecognizer *)sender
{
    if (sender.state == UIGestureRecognizerStateRecognized) {
        ...
        ActionSheetAction *verifyAction = [[ActionSheetAction alloc]
            initWithTitle:(hasMultiple ? NSLocalizedString(@"XXGJUSTHHANQV9",
                               @"Label for button or row which allows users to verify the safety "
                               @"numbers of multiple users.")
                                       : NSLocalizedString(@"XXGJUSTHHANQV8",
                                           @"Label for button or row which allows users to verify the safety "
...
- (void)updateBarButtonItems
{
    ...
    if ([self canCall]) {
        ...
        callButton.accessibilityLabel = NSLocalizedString(@"XXGJUSTHHANQC1", "Accessibility label for placing call button");
...
- (void)updateNavigationBarSubtitleLabel
{
    ...
    [subtitleText
        appendAttributedString:[[NSAttributedString alloc]
                                   initWithString:NSLocalizedString(@"XXGJUSTHHANQM56",
...
- (void)handleUnsentMessageTap:(TSOutgoingMessage *)message
{
    ...
    ActionSheetAction *deleteMessageAction = [[ActionSheetAction alloc]
        initWithTitle:NSLocalizedString(@"XXGJUSTHHANQT20", @"")
    ...
    ActionSheetAction *resendMessageAction = [[ActionSheetAction alloc]
                  initWithTitle:NSLocalizedString(@"XXGJUSTHHANQS39", @"")
...
- (void)tappedCorruptedMessage:(TSErrorMessage *)message
{
    ...
    NSString *alertMessage = [NSString
        stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQC126", @"ActionSheet title"), threadName];
    ...
    ActionSheetAction *resetSessionAction = [[ActionSheetAction alloc]
                  initWithTitle:NSLocalizedString(@"XXGJUSTHHANQF5", @"")
...
- (void)tappedInvalidIdentityKeyErrorMessage:(TSInvalidIdentityKeyErrorMessage *)errorMessage
{
    ...
    NSString *titleFormat = NSLocalizedString(@"XXGJUSTHHANQS5", @"Action sheet heading");
    ...
    ActionSheetAction *showSafteyNumberAction =
        [[ActionSheetAction alloc] initWithTitle:NSLocalizedString(@"XXGJUSTHHANQS155", @"Action sheet item")
    ...
    ActionSheetAction *acceptSafetyNumberAction = [[ActionSheetAction alloc]
                  initWithTitle:NSLocalizedString(@"XXGJUSTHHANQA1", @"Action sheet item")
...
- (void)conversationCell:(ConversationViewCell *)cell didTapReactions:(id<ConversationViewItem>)viewItem
{
    ...
    [self presentFullScreenViewController:detailSheet animated:YES completion:nil];
...
- (void)tappedUnknownContactBlockOfferMessage:(OWSContactOffersInteraction *)interaction
{
    ...
    NSString *displayName = [self.contactsManager displayNameForAddress:contactThread.contactAddress];
    NSString *title =
        [NSString stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQB40",
    ...
    ActionSheetAction *blockAction = [[ActionSheetAction alloc]
                  initWithTitle:NSLocalizedString(@"XXGJUSTHHANQB39",
                  ...
                  imageView:(UIView *)imageView
{
    ...
    [self presentFullScreenViewController:pageVC animated:YES completion:nil];
}
...
- (void)chooseContactForSending
{
    ...
    contactsPicker.title
        = NSLocalizedString(@"XXGJUSTHHANQC76", @"navbar title for contact picker when sharing a contact");
...
- (void)showAttachmentDocumentPickerMenu
{
    ...
    ActionSheetAction *mediaAction = [[ActionSheetAction alloc]
        initWithTitle:NSLocalizedString(@"XXGJUSTHHANQM2", @"media picker option to choose from library")
                style:ActionSheetActionStyleDefault
              handler:^(ActionSheetAction *action) {
    ...
    ActionSheetAction *browseAction = [[ActionSheetAction alloc]
        initWithTitle:NSLocalizedString(@"XXGJUSTHHANQB52", @"browse files option from file sharing menu")
                style:ActionSheetActionStyleDefault
              handler:^(ActionSheetAction *action) {
...
- (void)showDocumentPicker
{
    ...
    [self dismissKeyBoard];
    [self presentFullScreenViewController:pickerController animated:YES completion:nil];
}
...
- (void)showGifPicker
{
    ...
    [self dismissKeyBoard];
    [self presentFullScreenViewController:gifModal animated:YES completion:nil];
}
    ...
    didPickDocumentPicker:(UIDocumentPickerViewController *)documentPicker
{
    ...
    [self dismissKeyBoard];
    [self presentFullScreenViewController:documentPicker animated:YES completion:nil];
}
...
- (void)documentPicker:(UIDocumentPickerViewController *)controller didPickDocumentAtURL:(NSURL *)url
{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [OWSActionSheets
                showActionSheetWithTitle:
                    NSLocalizedString(@"XXGJUSTHHANQA70",
    ...
    if (!filename) {
        ...
        filename = NSLocalizedString(
            @"XXGJUSTHHANQA2", @"Generic filename for an attachment with no known name");
    }
    ...
    if (dataSource == nil) {
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            [OWSActionSheets
                showActionSheetWithTitle:NSLocalizedString(@"XXGJUSTHHANQA68",
...
- (void)endRecordingVoiceMemo
{
    ...
    if (durationSeconds < kMinimumRecordingTimeSeconds) {
        ...
        [OWSActionSheets
            showActionSheetWithTitle:
                NSLocalizedString(@"XXGJUSTHHANQA71",
                    @"Title for the alert indicating the 'voice message' needs to be held to be held down to record.")
                             message:NSLocalizedString(@"XXGJUSTHHANQV15",
    ...
    NSString *filename = [NSLocalizedString(@"XXGJUSTHHANQA71", @"Filename for voice messages.")
...
- (void)showErrorAlertForAttachment:(SignalAttachment *_Nullable)attachment
{
    ...
    [OWSActionSheets showActionSheetWithTitle:NSLocalizedString(@"XXGJUSTHHANQA49",
...
- (void)presentMissingQuotedReplyToast
{
    ...
    NSString *toastText = NSLocalizedString(@"XXGJUSTHHANQQ6",
...
- (void)presentRemotelySourcedQuotedReplyToast
{
    ...
    NSString *toastText = NSLocalizedString(@"XXGJUSTHHANQQ7",
        @"Toast alert text shown when tapping on a quoted message which we cannot scroll to because the local copy of "
...
- (void)presentViewOnceAlreadyViewedToast
{
    ...
    NSString *toastText = NSLocalizedString(@"XXGJUSTHHANQV10",
...
- (void)presentViewOnceOutgoingToast
{
    ...
    NSString *toastText = NSLocalizedString(
        @"XXGJUSTHHANQV13", @"Toast alert text shown when tapping on a view-once message that you have sent.");
...
- (void)messageRequestViewDidTapLearnMore
{
    ...
    SFSafariViewController *safariVC = [[SFSafariViewController alloc]
        initWithURL:[NSURL URLWithString:@"http://blog.sina.cn/dpool/blog/s/blog_a0fbb91f0102yvn8.html?md=gd"]];
    [self presentFullScreenViewController:safariVC animated:YES completion:nil];
}
