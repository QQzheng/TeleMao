...
- (nullable UIView *)createTapForMoreLabelIfNecessary
{
    ...
    tapForMoreLabel.text = NSLocalizedString(@"XXGJUSTHHANQC124",
...
- (UIView *)loadViewForMediaAlbum
{
    ...
    albumView.accessibilityLabel =
        [OWSMessageView accessibilityLabelWithDescription:NSLocalizedString(@"XXGJUSTHHANQA5",
...
- (UIView *)loadViewForAudio
{
    ...
    audioMessageView.accessibilityLabel =
        [OWSMessageView accessibilityLabelWithDescription:NSLocalizedString(@"XXGJUSTHHANQA3",
...
- (UIView *)loadViewForGenericAttachment
{
    ...
    attachmentView.accessibilityLabel =
        [OWSMessageView accessibilityLabelWithDescription:NSLocalizedString(@"XXGJUSTHHANQA2",
...
- (UIView *)loadViewForContactShare
{
    ...
    contactShareView.accessibilityLabel =
        [OWSMessageView accessibilityLabelWithDescription:NSLocalizedString(@"XXGJUSTHHANQA4",
...
- (void)addTapToRetryView:(UIView *)bodyMediaView
{
    ...
    label.text = NSLocalizedString(
        @"XXGJUSTHHANQA48", @"Status label when an attachment download has failed.");
