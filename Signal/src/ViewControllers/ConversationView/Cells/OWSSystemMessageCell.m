    ...
    switch (message.errorType) {
        ...
        case TSErrorMessageNonBlockingIdentityChange:
            return [SystemMessageAction
                        actionWithTitle:NSLocalizedString(@"XXGJUSTHHANQS178",
        ...
        case TSErrorMessageNoSession:
            return nil;
        case TSErrorMessageInvalidMessage:
            return [SystemMessageAction actionWithTitle:NSLocalizedString(@"XXGJUSTHHANQF5", @"")
                                                  block:^{
    ...
    switch (infoMessage.messageType) {
        ...
        case TSInfoMessageUnknownProtocolVersion: {
            ...
            if (message.isProtocolVersionUnknown) {
                return [SystemMessageAction
                            actionWithTitle:NSLocalizedString(@"XXGJUSTHHANQU8",
        ...
        case TSInfoMessageTypeDisappearingMessagesUpdate:
            return [SystemMessageAction
                        actionWithTitle:NSLocalizedString(@"XXGJUSTHHANQC112",
        ...
        case TSInfoMessageVerificationStateChange:
            return [SystemMessageAction
                        actionWithTitle:NSLocalizedString(@"XXGJUSTHHANQS155", @"Action sheet item")
                                  block:^{
                                      [weakSelf.delegate
...
- (nullable SystemMessageAction *)actionForCall:(TSCall *)call
{
    ...
    switch (call.callType) {
        ...
        case RPRecentCallTypeIncomingDeclined:
            return
                [SystemMessageAction actionWithTitle:NSLocalizedString(@"XXGJUSTHHANQC23", @"notification action")
                                               block:^{
        ...
        case RPRecentCallTypeOutgoingMissed:
            return [SystemMessageAction actionWithTitle:NSLocalizedString(@"XXGJUSTHHANQB48",
...
{
    NSString *url = @"https://apps.apple.com/cn/app/tmao/id1493263955";
