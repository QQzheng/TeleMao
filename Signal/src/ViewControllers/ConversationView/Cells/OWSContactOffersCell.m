...
- (void)commontInit
{
    ...
    self.titleLabel.text = NSLocalizedString(@"XXGJUSTHHANQC122",
    ...
    self.addToContactsButton = [self
        createButtonWithTitle:
            NSLocalizedString(@"XXGJUSTHHANQC120",
    ...
    self.addToProfileWhitelistButton = [self
        createButtonWithTitle:NSLocalizedString(@"XXGJUSTHHANQC121",
    ...
    self.blockButton =
        [self createButtonWithTitle:NSLocalizedString(@"XXGJUSTHHANQC125",
