...
- (UIView *)loadStickerView
{
    ...
    stickerView.accessibilityLabel =
        [OWSMessageView accessibilityLabelWithDescription:NSLocalizedString(@"XXGJUSTHHANQA8",
...
- (UIView *)loadFailedStickerView
{
    ...
    label.text = NSLocalizedString(@"XXGJUSTHHANQS161", @"Label for a sticker that failed to download.");
