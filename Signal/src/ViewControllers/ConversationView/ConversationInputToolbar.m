...
- (void)createContents
{
    ...
    self.cameraButton.accessibilityLabel
        = NSLocalizedString(@"XXGJUSTHHANQA60", @"Accessibility label for camera button.");
    self.cameraButton.accessibilityHint = NSLocalizedString(
        @"XXGJUSTHHANQC25", @"Accessibility hint describing what you can do with the camera button");
    ...
    self.attachmentButton.accessibilityLabel
        = NSLocalizedString(@"XXGJUSTHHANQA2", @"Accessibility label for attaching photos");
    self.attachmentButton.accessibilityHint = NSLocalizedString(
        @"XXGJUSTHHANQA59", @"Accessibility hint describing what you can do with the attachment button");
    ...
    self.voiceMemoButton.accessibilityLabel = NSLocalizedString(@"XXGJUSTHHANQA71",
    ...
    self.stickerButton.accessibilityLabel = NSLocalizedString(@"XXGJUSTHHANQI17",
...
- (void)showVoiceMemoUI
{
    ...
    [cancelString
        appendAttributedString:[[NSAttributedString alloc]
                                   initWithString:NSLocalizedString(@"XXGJUSTHHANQV14",
