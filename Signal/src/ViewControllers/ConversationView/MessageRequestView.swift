...
class MessageRequestView: UIStackView {
    ...
    func prepareButtons(hasSentMessages: Bool) -> UIStackView {
        ...
        if hasSentMessages {
            let learnMoreButton = prepareButton(title: NSLocalizedString("XXGJUSTHHANQM35",
            ...
            let shareProfileButton = prepareButton(title: NSLocalizedString("XXGJUSTHHANQM38",
            ...
            let blockButton = prepareButton(title: NSLocalizedString("XXGJUSTHHANQB39",
            ...
            let deleteButton = prepareButton(title: NSLocalizedString("XXGJUSTHHANQM32",
                                                                      comment: "A button used to block a user on an incoming message request."),
                                             titleColor: .ows_accentRed) { [weak self] in
            ...
            let acceptButton = prepareButton(title: NSLocalizedString("XXGJUSTHHANQM31",
                                                                      comment: "A button used to block a user on an incoming message request."),
                                             titleColor: .ows_signalBlue) { [weak self] in
                                                self?.delegate?.messageRequestViewDidTapAccept()
            }
