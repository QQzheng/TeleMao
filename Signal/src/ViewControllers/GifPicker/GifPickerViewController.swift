...
class GifPickerViewController: OWSViewController, UISearchBarDelegate, UICollectionViewDataSource, UICollectionViewDelegate, GifPickerLayoutDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = NSLocalizedString("XXGJUSTHHANQG8",
    ...
    private func createViews() {
        ...
        searchBar.placeholder = NSLocalizedString("XXGJUSTHHANQG11",
        ...
        let noResultsView = createErrorLabel(text: NSLocalizedString("XXGJUSTHHANQG10",
        ...
        let searchErrorView = createErrorLabel(text: NSLocalizedString("XXGJUSTHHANQG9",
    ...
    public func getFileForCell(_ cell: GifPickerCell) {
        ...
        firstly {
            ...
            let alert = ActionSheetController(title: NSLocalizedString("XXGJUSTHHANQG6", comment: "Shown when selected GIF couldn't be fetched"),
    ...
    public func tryToSearch() {
        ...
        guard let text = searchBar.text else {
            OWSActionSheets.showErrorAlert(message: NSLocalizedString("XXGJUSTHHANQG7",
