...
public class LoadingViewController: UIViewController {
    ...
    override public func loadView() {
        ...
        self.logoView = UIImageView(image: #imageLiteral(resourceName: "iconLaunch"))
        ...
        topLabel.text = NSLocalizedString("XXGJUSTHHANQD2", comment: "Title shown while the app is updating its database.")
        labelStack.addArrangedSubview(topLabel)

        self.bottomLabel = buildLabel()
        bottomLabel.alpha = 0
        bottomLabel.font = UIFont.ows_dynamicTypeBody
        bottomLabel.text = NSLocalizedString("XXGJUSTHHANQD1", comment: "Subtitle shown while the app is updating its database.")
