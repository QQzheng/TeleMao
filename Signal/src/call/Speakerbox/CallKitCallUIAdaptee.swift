...
final class CallKitCallUIAdaptee: NSObject, CallUIAdaptee, CXProviderDelegate {
    ...
    class func buildProviderConfiguration(useSystemCallLog: Bool) -> CXProviderConfiguration {
        let localizedName = NSLocalizedString("XXGJUSTHHANQA36", comment: "Name of application")
        ...
        let iconMaskImage = #imageLiteral(resourceName: "iconLaunch")
    ...
    func reportIncomingCall(_ call: SignalCall, callerName: String) {
        ...
        if showNamesOnCallScreen {
            ...
            update.localizedCallerName = NSLocalizedString("XXGJUSTHHANQC24", comment: "The generic name used for calls if CallKit privacy is enabled")
        }
    ...
    func provider(_ provider: CXProvider, perform action: CXStartCallAction) {
        ...
        if !showNamesOnCallScreen {
            let update = CXCallUpdate()
            update.localizedCallerName = NSLocalizedString("XXGJUSTHHANQC24",
    ...
    public func provider(_ provider: CXProvider, perform action: CXSetHeldCallAction) {
        ...
        // Tmao to the system that the action has been successfully performed.
        action.fulfill()
    }
