...
/**
 * `CallService` is a global singleton that manages the state of RingRTC-backed Tmao
 ...
 * is established, this must happen out of band (using the Tmao Service), but once the
 ...
 * SS: Message sent via Tmao Service
