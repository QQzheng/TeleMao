...
- (void)start
{
    ...
    [[self.backup ensureCloudKitAccess]
            .thenInBackground(^{
                [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB10",
            ...
            .thenInBackground(^{
                ...
                [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB13",
            ...
            .catch(^(NSError *error) {
                [self failWithErrorDescription:
                          NSLocalizedString(@"XXGJUSTHHANQB9",
        ...
        promise = promise
                      .thenInBackground(^{
                          ...
                          [self updateProgressWithDescription:
                                    NSLocalizedString(@"XXGJUSTHHANQB11",
...
- (AnyPromise *)restoreAttachmentFiles
{
    ...
    [self.databaseStorage writeWithBlock:^(SDSAnyWriteTransaction *transaction) {
        for (OWSBackupFragment *item in self.attachmentsItems) {
            ...
            count++;
            [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB14",
...
- (AnyPromise *)restoreDatabase
{
    ...
    // POST GRDB TODO: We need to totally rework this, post GRDB.
        ...
        for (OWSBackupFragment *item in self.databaseItems) {
            ...
            count++;
            [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB15",
...
- (AnyPromise *)ensureMigrations
{
    ...
    [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB12",
