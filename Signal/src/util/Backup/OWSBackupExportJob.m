...
- (void)start
{
    ...
    [[self.backup ensureCloudKitAccess]
            .thenInBackground(^{
                [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB5",
            ...
            .thenInBackground(^{
                [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB7",
            ...
            .catch(^(NSError *error) {
                ...
                [self failWithErrorDescription:
                          NSLocalizedString(@"XXGJUSTHHANQB2",
...
- (BOOL)performExportDatabase
{
    ...
    [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB6",
...
- (AnyPromise *)saveToCloud
{
    ...
    [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB8",
...
- (AnyPromise *)cleanUp
{
    ...
    [self updateProgressWithDescription:NSLocalizedString(@"XXGJUSTHHANQB4",
