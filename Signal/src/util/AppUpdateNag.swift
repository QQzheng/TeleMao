...
class AppUpdateNag: NSObject {
    ...
    func presentUpgradeNag(appStoreRecord: AppStoreRecord) {
        let title = NSLocalizedString("XXGJUSTHHANQA31", comment: "Title for the 'new app version available' alert.")

        let bodyFormat = NSLocalizedString("XXGJUSTHHANQA30", comment: "Message format for the 'new app version available' alert. Embeds: {{The latest app version number}}")
        let bodyText = String(format: bodyFormat, appStoreRecord.version)
        let updateButtonText = NSLocalizedString("XXGJUSTHHANQA32", comment: "Label for the 'update' button in the 'new app version available' alert.")
        let dismissButtonText = NSLocalizedString("XXGJUSTHHANQA0", comment: "Label for the 'dismiss' button in the 'new app version available' alert.")
