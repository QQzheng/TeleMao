...
public class SearchResultsBar: UIView {
    ...
    func updateBarItems() {
        ...
        case 0:
            labelItem.title = NSLocalizedString("XXGJUSTHHANQC91", comment: "keyboard toolbar label when no messages match the search string")
        case 1:
            labelItem.title = NSLocalizedString("XXGJUSTHHANQC92", comment: "keyboard toolbar label when exactly 1 message matches the search string")
        default:
            let format = NSLocalizedString("XXGJUSTHHANQC93",
