...
+ (NSString *)formatDurationSeconds:(uint32_t)durationSeconds useShortFormat:(BOOL)useShortFormat
{
    ...
    if (durationSeconds < secondsPerMinute) { // XX Seconds
        if (useShortFormat) {
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT12",
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT11",
        ...
        if (useShortFormat) {
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT10",
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT15",
        ...
        if (useShortFormat) {
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT9",
        ...
        if (useShortFormat) {
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT8",
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT14",
        ...
        if (useShortFormat) {
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT7",
        ...
        if (useShortFormat) {
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT6",
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT13",
        ...
        if (useShortFormat) {
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT5",
        ...
        if (useShortFormat) {
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT18",
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT16",
        ...
        if (useShortFormat) {
            ...
            amountFormat = NSLocalizedString(@"XXGJUSTHHANQT17",
