                      ...
                      completionBlock:(nullable BlockActionCompletionBlock)completionBlock
{
    ...
    for (SignalServiceAddress *address in addresses) {
        ...
        if (address.isLocalAddress) {
            [self showOkAlertWithTitle:NSLocalizedString(@"XXGJUSTHHANQA19",
                                           @"The title of the 'You can't block yourself' alert.")
                               message:NSLocalizedString(@"XXGJUSTHHANQB35",
    ...
    NSString *title = [NSString stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQB24",
    ...
    ActionSheetController *actionSheet = [[ActionSheetController alloc]
        initWithTitle:title
              message:NSLocalizedString(@"XXGJUSTHHANQB41",
                          @"An explanation of the consequences of blocking another user.")];

    ActionSheetAction *blockAction = [[ActionSheetAction alloc]
                  initWithTitle:NSLocalizedString(@"XXGJUSTHHANQB22", @"Button label for the 'block' button")
                  ...
                  completionBlock:(nullable BlockActionCompletionBlock)completionBlock
{
    ...
    NSString *title = [NSString
        stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQB23",
    ...
    ActionSheetController *actionSheet =
        [[ActionSheetController alloc] initWithTitle:title
                                             message:NSLocalizedString(@"XXGJUSTHHANQB21",
       ...
       completionBlock:(BlockAlertCompletionBlock)completionBlock
{
    ...
    [self showOkAlertWithTitle:NSLocalizedString(
                                   @"XXGJUSTHHANQB33", @"The title of the 'user blocked' alert.")
                       message:[NSString
                                   stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQB32",
       ...
       completionBlock:(BlockAlertCompletionBlock)completionBlock
{
    ...
    NSString *alertTitle
        = NSLocalizedString(@"XXGJUSTHHANQB34", @"The title of the 'group blocked' alert.");
    NSString *alertBodyFormat = NSLocalizedString(@"XXGJUSTHHANQB32",
                        ...
                        completionBlock:(nullable BlockActionCompletionBlock)completionBlock
{
    ...
    NSString *title = [NSString
        stringWithFormat:
            NSLocalizedString(@"XXGJUSTHHANQB30",
    ...
    ActionSheetAction *unblockAction =
        [[ActionSheetAction alloc] initWithTitle:NSLocalizedString(@"XXGJUSTHHANQB27",
         ...
         completionBlock:(BlockAlertCompletionBlock)completionBlock
{
    ...
    NSString *titleFormat = NSLocalizedString(@"XXGJUSTHHANQB37",
                    ...
                    completionBlock:(nullable BlockActionCompletionBlock)completionBlock
{
    ...
    NSString *title =
        [NSString stringWithFormat:NSLocalizedString(@"XXGJUSTHHANQB29",
                                       @"Action sheet title when confirming you want to unblock a group.")];

    NSString *message = NSLocalizedString(
        @"XXGJUSTHHANQB28", @"Action sheet body when confirming you want to unblock a group");
       ...
       completionBlock:(BlockAlertCompletionBlock)completionBlock
{
    ...
    NSString *message
        = NSLocalizedString(@"XXGJUSTHHANQB38", @"Alert body after unblocking a group.");
