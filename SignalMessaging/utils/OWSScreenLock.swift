...
public class OWSScreenLock: NSObject {
    ...
    public func tryToUnlockScreenLock(success: @escaping (() -> Void),
        ...
        tryToVerifyLocalAuthentication(localizedReason: NSLocalizedString("XXGJUSTHHANQS14",
    ...
    private func tryToVerifyLocalAuthentication(localizedReason: String,
        ...
        let defaultErrorDescription = NSLocalizedString("XXGJUSTHHANQS8",
        ...
        if let error = errorParam {
            ...
            if #available(iOS 11.0, *) {
                ...
                case .biometryNotAvailable:
                    ...
                    return .failure(error: NSLocalizedString("XXGJUSTHHANQS11",
                ...
                case .biometryNotEnrolled:
                    ...
                    return .failure(error: NSLocalizedString("XXGJUSTHHANQS12",
                ...
                case .biometryLockout:
                    ...
                    return .failure(error: NSLocalizedString("XXGJUSTHHANQS10",
            ...
            case .authenticationFailed:
                ...
                return .failure(error: NSLocalizedString("XXGJUSTHHANQS9",
            ...
            case .passcodeNotSet:
                ...
                return .failure(error: NSLocalizedString("XXGJUSTHHANQS13",
