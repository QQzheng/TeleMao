...
public class ContactShareApprovalViewController: OWSViewController, EditContactShareNameViewControllerDelegate, ContactShareFieldViewDelegate {
    ...
    override public func loadView() {
        ...
        if let title = delegate?.contactApprovalCustomTitle(self) {
            ...
            self.navigationItem.title = NSLocalizedString("XXGJUSTHHANQC77",
    ...
    func createNameRow() -> UIView {
        ...
        editNameLabel.text = NSLocalizedString("XXGJUSTHHANQC58", comment: "Label for the 'edit name' button in the contact share approval view.")
    ...
    func didPressSendButton() {
        ...
        guard isAtLeastOneFieldSelected() else {
            OWSActionSheets.showErrorAlert(message: NSLocalizedString("XXGJUSTHHANQC80",
        ...
        guard contactShare.ows_isValid else {
            OWSActionSheets.showErrorAlert(message: NSLocalizedString("XXGJUSTHHANQC79",
