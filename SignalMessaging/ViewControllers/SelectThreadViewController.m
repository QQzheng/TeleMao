...
- (void)updateTableContents
{
    ...
    [findByPhoneSection
        addItem:[OWSTableItem disclosureItemWithText:NSLocalizedString(@"XXGJUSTHHANQN10",
    ...
    recentChatsSection.headerTitle = NSLocalizedString(
        @"XXGJUSTHHANQS38", @"Table section header for recently active conversations");
    ...
    otherContactsSection.headerTitle = NSLocalizedString(
        @"XXGJUSTHHANQS37", @"Table section header for conversations you haven't recently used.");
    ...
    if (recentChatsSection.itemCount + otherContactsSection.itemCount < 1) {
        ...
        [emptySection
            addItem:[OWSTableItem
                        softCenterLabelItemWithText:NSLocalizedString(@"XXGJUSTHHANQS80",
