...
public class ContactFieldView: UIView {
    ...
    public class func contactFieldView(forOrganizationName organizationName: String, layoutMargins: UIEdgeInsets) -> UIView {
        return simpleFieldView(name: NSLocalizedString("XXGJUSTHHANQC72",
    ...
    public class func contactFieldView(forAddress address: OWSContactAddress, layoutMargins: UIEdgeInsets, actionBlock : (() -> Void)?) -> UIView {
        ...
        tryToAddNameValue(NSLocalizedString("XXGJUSTHHANQC66", comment: "Label for the 'street' field of a contact's address."),
                          address.street)
        tryToAddNameValue(NSLocalizedString("XXGJUSTHHANQC63", comment: "Label for the 'pobox' field of a contact's address."),
                          address.pobox)
        tryToAddNameValue(NSLocalizedString("XXGJUSTHHANQC62", comment: "Label for the 'neighborhood' field of a contact's address."),
                          address.neighborhood)
        tryToAddNameValue(NSLocalizedString("XXGJUSTHHANQC60", comment: "Label for the 'city' field of a contact's address."),
                          address.city)
        tryToAddNameValue(NSLocalizedString("XXGJUSTHHANQC65", comment: "Label for the 'region' field of a contact's address."),
                          address.region)
        tryToAddNameValue(NSLocalizedString("XXGJUSTHHANQC64", comment: "Label for the 'postcode' field of a contact's address."),
                          address.postcode)
        tryToAddNameValue(NSLocalizedString("XXGJUSTHHANQC61", comment: "Label for the 'country' field of a contact's address."),
                          address.country)
