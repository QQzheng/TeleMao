...
- (void)loadView
{
    ...
    self.title = NSLocalizedString(@"XXGJUSTHHANQS154", @"Title for the 'share extension' view.");
}
...
{
    return NSLocalizedString(@"XXGJUSTHHANQA6", @"Title for the 'message approval' dialog.");
}
               ...
               fromViewController:(UIViewController *)fromViewController
{
    ...
    titleLabel.text = NSLocalizedString(@"XXGJUSTHHANQS152", @"Alert title");
                   ...
                   fromViewController:(UIViewController *)fromViewController
{
    ...
    NSString *failureTitle = NSLocalizedString(@"XXGJUSTHHANQS151", @"Alert title");
    ...
    if ([error.domain isEqual:OWSSignalServiceKitErrorDomain] && error.code == OWSErrorCodeUntrustedIdentity) {
        ...
        NSString *failureFormat = NSLocalizedString(@"XXGJUSTHHANQS145",
...
- (void)resendMessage:(TSOutgoingMessage *)message fromViewController:(UIViewController *)fromViewController
{
    ...
    NSString *progressTitle = NSLocalizedString(@"XXGJUSTHHANQS152", @"Alert title");
