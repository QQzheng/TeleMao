...
class AttachmentTextToolbar: UIView, UITextViewDelegate {
    ...
    init(options: AttachmentApprovalViewControllerOptions, sendButtonImageName: String) {
        ...
        sendButton.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQA46", comment: "Label for 'send' button in the 'attachment approval' dialog.")
    ...
    private lazy var placeholderTextView: UITextView = {
        ...
        placeholderTextView.text = NSLocalizedString("XXGJUSTHHANQK10", comment: "placeholder text for the editable message field")
