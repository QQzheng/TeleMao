...
class AttachmentCaptionViewController: OWSViewController {
    ...
    private lazy var lengthLimitLabel: UILabel = {
        ...
        lengthLimitLabel.text = NSLocalizedString("XXGJUSTHHANQA39", comment: "One-line label indicating the user can add no more text to the attachment caption.")
    ...
    private lazy var placeholderTextView: UIView = {
        ...
        placeholderTextView.text = NSLocalizedString("XXGJUSTHHANQA40", comment: "placeholder text for an empty captioning field")
