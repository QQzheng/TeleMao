...
public class FindByPhoneNumberViewController: OWSViewController {
    ...
    override public func viewDidLoad() {
        ...
        title = NSLocalizedString("XXGJUSTHHANQN22",
        ...
        countryRowTitleLabel.text = NSLocalizedString("XXGJUSTHHANQR27", comment: "Label for the country code field")
        ...
        phoneNumberRowTitleLabel.text = NSLocalizedString("XXGJUSTHHANQR32",
        ...
        phoneNumberTextField.placeholder = NSLocalizedString("XXGJUSTHHANQR28",
        ...
        let buttonTitle = buttonText ?? NSLocalizedString("XXGJUSTHHANQH3",
...
extension FindByPhoneNumberViewController: CountryCodeViewControllerDelegate {
    ...
    @objc func didTapCountryRow() {
        ...
        presentFullScreen(OWSNavigationController(rootViewController: countryCodeController), animated: true)
    }
