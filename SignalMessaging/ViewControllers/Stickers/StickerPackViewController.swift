...
public class StickerPackViewController: OWSViewController {
    ...
    public func present(from fromViewController: UIViewController,
        ...
        AssertIsOnMainThread()
            ...
            if #available(iOS 13, *) {
                ...
                fromViewController.presentFullScreen(self, animated: animated) {
    ...
    override public func loadView() {
        ...
        let installButton = OWSFlatButton.button(title: NSLocalizedString("XXGJUSTHHANQS162", comment: "Label for the 'install sticker pack' button."),
        ...
        let uninstallButton = OWSFlatButton.button(title: NSLocalizedString("XXGJUSTHHANQS175", comment: "Label for the 'uninstall sticker pack' button."),
                                             font: UIFont.ows_dynamicTypeBody.ows_semibold(),
                                             titleColor: UIColor.ows_signalBlue,
                                             backgroundColor: UIColor.white,
                                             target: self,
        ...
        loadFailedLabel.text = NSLocalizedString("XXGJUSTHHANQS174",
    ...
    private func updateContent() {
        ...
        let defaultTitle = NSLocalizedString("XXGJUSTHHANQS173", comment: "The default title for the 'sticker pack' view.")
