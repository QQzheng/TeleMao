...
public class ManageStickersViewController: OWSTableViewController {
    ...
    override public func loadView() {
        ...
        navigationItem.title = NSLocalizedString("XXGJUSTHHANQS170", comment: "Title for the 'manage stickers' view.")
    ...
    private func updateTableContents() {
        ...
        installedSection.headerTitle = NSLocalizedString("XXGJUSTHHANQS166", comment: "Title for the 'installed stickers' section of the 'manage stickers' view.")
        if installedStickerPackSources.count < 1 {
            let text = NSLocalizedString("XXGJUSTHHANQS168", comment: "Label indicating that the user has no installed sticker packs.")
        ...
        if availableBuiltInStickerPackSources.count > 0 {
            ...
            section.headerTitle = NSLocalizedString("XXGJUSTHHANQS163", comment: "Title for the 'available built-in stickers' section of the 'manage stickers' view.")
        ...
        knownSection.headerTitle = NSLocalizedString("XXGJUSTHHANQS164", comment: "Title for the 'available known stickers' section of the 'manage stickers' view.")
        if knownStickerPackSources.count < 1 {
            let text = NSLocalizedString("XXGJUSTHHANQS169", comment: "Label indicating that the user has no known sticker packs.")
    ...
    private func buildTableCell(dataSource: StickerPackDataSource,
        ...
        if let titleValue = titleValue?.ows_stripped(),
            ...
            title = NSLocalizedString("XXGJUSTHHANQS171", comment: "Default title for sticker packs.")
        }
