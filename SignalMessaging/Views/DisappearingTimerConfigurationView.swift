...
public class DisappearingTimerConfigurationView: UIView {
    ...
    public init(durationSeconds: UInt32) {
        ...
        // Accessibility
        self.accessibilityLabel = NSLocalizedString("XXGJUSTHHANQD31", comment: "Accessibility label for disappearing messages")
        let hintFormatString = NSLocalizedString("XXGJUSTHHANQD30", comment: "Accessibility hint that contains current timeout information")
